...
public class AttendantController {
	...
	public AttendantResponse update(@PathVariable Long id, @Valid @RequestBody AttendantUpdateRequest request) {
		return attendantService.update(id, request);
	}

	@PatchMapping("/{id}/status")
	@Operation(summary = "Atualizar status operacional do atendente")
	public AttendantResponse updateStatus(@PathVariable Long id, @Valid @RequestBody AttendantStatusRequest request) {
		return attendantService.updateStatus(id, request);
	}
}
